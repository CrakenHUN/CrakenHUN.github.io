...
function handleLiClick(event) {
    if(variableDict[this.innerText]) {
        ...
        this.style.color = "#DB170F"
        this.style.border = "1px solid #DB170F"
        this.style.backgroundColor = "#FFCCC5"
    } else {
        console.log("false branch")
        variableDict[this.innerText] = true
        this.style.color = "#d1e3fa"
        this.style.border = "1px solid #d1e3fa"
        this.style.backgroundColor = "#3C4A5C"
    }
    evaluationSteps.innerHTML = ' '
    submitLogicInput()
}